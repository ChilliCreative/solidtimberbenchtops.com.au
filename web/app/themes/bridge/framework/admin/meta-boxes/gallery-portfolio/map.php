...
$qodePortfolioImages = new QodeMetaBox("gallery-portfolio", "Qode Portfolio Images (multiple upload)");
...
$qodePortfolioImagesVideos = new QodeMetaBox("gallery-portfolio", "Qode Portfolio Images/Videos (single upload)");
...
$qodePortfolioImagesVideos2 = new QodeMetaBox("gallery-portfolio", "Qode Portfolio Images/Videos (single upload)");
...
$qodeAdditionalSidebarItems = new QodeMetaBox("gallery-portfolio", "Qode Additional Portfolio Sidebar Items");
...
$qodeGeneral = new QodeMetaBox("gallery-portfolio", "Qode General");
...
$qodeHeader = new QodeMetaBox("gallery-portfolio", "Qode Header","vertical_area",array("yes"));
...
$qodeLeftMenuArea = new QodeMetaBox("gallery-portfolio", "Qode Left Menu Area","vertical_area",array("no"));
...
$qodeTitle = new QodeMetaBox("gallery-portfolio", "Qode Title");
...
$qodeTitleAnimations = new QodeMetaBox('gallery-portfolio', 'Qode Scroll Title Animations', 'qode_show-page-title', array('yes'));
...
$qodeContentBottom = new QodeMetaBox("gallery-portfolio", "Qode Content Bottom");
...
$qodeSideBar = new QodeMetaBox("gallery-portfolio", "Qode Sidebar");
...
$qodeSeo = new QodeMetaBox("gallery-portfolio", "Qode SEO");
