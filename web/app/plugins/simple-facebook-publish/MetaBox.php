...
class MetaBox
{
    ...
    public function saveMetaBox($post_id)
    {
        ...
        if (isset($_POST['simple_facebook_publish_post'])) {
            $data = [];
            $data['link'] = str_replace(array('http://', 'https://'), '', rwmb_meta( 'company-url' ));
            $data['message'] = str_replace(array("&nbsp;", ''), '', wp_strip_all_tags($_POST['content']));
            $data['name'] = rwmb_meta( 'company-name' );
            $data['description'] = str_replace(array("&nbsp;", ''), '', wp_strip_all_tags($_POST['content']));
            $data['caption'] = str_replace(array('http://', 'https://'), '', rwmb_meta( 'company-url' ));
